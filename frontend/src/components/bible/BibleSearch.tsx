...
const BibleSearch: React.FC = () => {
  ...
  const performSearch = useCallback(async (searchQuery: string, pageNum: number = 1) => {
    ...
    try {
      ...
      const response = await api.get<SearchResponse>('/bible/search', {
        params: {
          q: searchQuery,
  ...
  return (
    <Box data-testid="bible-search" sx={{ p: 2 }}>
      {/* Header */}
                  ...
                  <ListItemText
                    primary={
                      <Box display="flex" alignItems="center" gap={1} mb={1}>
                        <Chip
                          label={`${result.livre.abbrev} ${result.chapitre.numero}:${result.numero}`}
                          size="small"
                          color="primary"
                        />
                    ...
                    secondary={
                      ...
                      >
                        {highlightQuery(result.texte, query)}
                      </Typography>
                    }
                  />
                </ListItem>
